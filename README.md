<h1 align = "center"> <em>printf('</em> Hello word, my name is Melvin =) <em>')</em> <br>  <img src="https://github.com/claytonjhamilton/claytonjhamilton/blob/main/images/waving_hand.gif" width="40px"></h1>
